  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex gap-2 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <div className="space-y-3 p-6">
                  {Array.from({ length: 4 }).map((__, itemIndex) => (
                    <div key={itemIndex} className="h-5 w-full rounded-full bg-slate-100 dark:bg-slate-900" />
                  ))}
                </div>
              </div>
            </div>
